...
class DatosActualizadosAlumno extends React.Component {
    ...
    render() {
        if (this.state.status) {
            ...
            return (<Redirect push to="/MisDatosAlumno"/>);
        } else {
                ...
                <div className="center">
                    <div id="sidebar" className="datosAlumno">
                        ...
                        <div>
                            ...
                            <input type="text" className="input_login" name="apellidoPaterno"
                                   ref={this.apellidoPaternoRef} placeholder="Apellido Paterno"
                        ...
                        <div>
                            ...
                            <input type="text" className="input_login" name="apellidoMaterno"
                                   ref={this.apellidoMaternoRef} placeholder="Apellido Materno"
                                   onChange={this.changeState}/>
                            {(() => {
                        ...
                        <div>
                            ...
                            <select name="programa" className="input_login" ref={this.programaAcademicoRef}
                                ...
                                <option value="INGENIERÍA EN COMUNICACIONES Y ELECTRÓNICA">INGENIERÍA EN COMUNICACIONES
                                    Y ELECTRÓNICA
                                </option>
                                <option value="INGENIERÍA ELÉCTRICA">INGENIERÍA ELÉCTRICA</option>
                                <option value="INGENIERÍA EN SISTEMAS AUTOMOTRICES">INGENIERÍA EN SISTEMAS
                                    AUTOMOTRICES
                                </option>
                            </select>
                        </div>
