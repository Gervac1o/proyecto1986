...
public class DocsServicioRestController {
    ...
    @PostMapping(path = "/upload/{idServicio}")
    public void store(@RequestParam("file") MultipartFile file, @PathVariable("idServicio") Integer idServicio)  throws EmptyResultException {

    	docServicioService.store(file, idServicio);
